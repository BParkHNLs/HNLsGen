...
process.BFilter = cms.EDFilter("MCMultiParticleFilter",
   ...
   ParticleID = cms.vint32(511), # abs not needed
...
process.SingleMuFromBFilter = cms.EDFilter("PythiaFilterMotherSister", 
    ...
    MotherIDs = cms.untracked.vint32(511), # require muon to come from B+/B- decay
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            operates_on_particles = cms.vint32(511, -511), #B+, B-, B0, B0bar, B0s, B0sbar   # 541 is Bc+
            ...
            ### The decay file 
            user_decay_file = cms.vstring('HNLsGen/evtGenData/HNLdecay_mass{m}_{dm}_{de}_Bd.DEC'.format(\
                                             m=options.mass, 
