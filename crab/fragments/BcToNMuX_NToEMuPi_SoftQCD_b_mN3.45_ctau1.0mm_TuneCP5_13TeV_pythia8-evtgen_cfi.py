...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Bc -> mu N X, with long-lived N, m=3.45GeV, ctau=1.0mm'),
    name = cms.untracked.string('Bc -> mu N X, with long-lived N, m=3.45GeV, ctau=1.0mm'),
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_embedded = cms.vstring(
               ...
               'Decay myBc+',
               '47.1938725558               mu+    myHNL_mu    PHSP;',
               '47.1938725558               mu+    myHNL_e     PHSP;',
               '47.1280689488                e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myBc-',
               'Decay myHNL_mu',
               '0.5     mu-    pi+    PHSP;',
