...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Bc -> mu N X, with long-lived N, m=4.30GeV, ctau=0.1mm'),
    name = cms.untracked.string('Bc -> mu N X, with long-lived N, m=4.30GeV, ctau=0.1mm'),
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_embedded = cms.vstring(
               ...
               'Decay myBc+',
               '42.3406985376               mu+    myHNL_mu    PHSP;',
               '42.3406985376               mu+    myHNL_e     PHSP;',
               '42.3101603899                e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myBc-',
               'Decay myHNL_mu',
               '0.5     mu-    pi+    PHSP;',
