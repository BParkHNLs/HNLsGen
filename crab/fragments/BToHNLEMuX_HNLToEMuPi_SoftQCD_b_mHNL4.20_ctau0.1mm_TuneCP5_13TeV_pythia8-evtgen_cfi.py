...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=4.20GeV, ctau=0.1mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=4.20GeV, ctau=0.1mm'),
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            #particle_property_file = cms.FileInPath('GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass4.20_ctau0.1_maj.pdl'),
            #particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_BHNL_mass4.20_ctau0.1_maj.pdl'),
            particle_property_file = cms.FileInPath('evt_BHNL_mass4.20_ctau0.1_maj.pdl'),
            #particle_property_file = cms.FileInPath('/GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass4.20_ctau0.1_maj.pdl'),
            #particle_property_file = cms.FileInPath('evt_BHNL_mass4.20_ctau0.1_maj.pdl'),
            user_decay_embedded = cms.vstring(
               ...
               'Decay myB+',
               '0.0989555662               mu+    myHNL_mu    PHSP;',
               '0.0000000000    anti-D0    mu+    myHNL_mu    PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_mu    PHSP;',
               '0.0024812353    pi0        mu+    myHNL_mu    PHSP;',
               '0.0000881789    rho0       mu+    myHNL_mu    PHSP;',
               '0.0989555662               mu+    myHNL_e     PHSP;',
               '0.0000000000    anti-D0    mu+    myHNL_e     PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_e     PHSP;',
               '0.0024812353    pi0        mu+    myHNL_e     PHSP;',
               '0.0000881789    rho0       mu+    myHNL_e     PHSP;',
               '0.0990524583                e+     myHNL_mu    PHSP;',
               '0.0000000000     anti-D0    e+     myHNL_mu    PHSP;',
               '0.0000000000     anti-D*0   e+     myHNL_mu    PHSP;',
               '0.0025379300     pi0        e+     myHNL_mu    PHSP;',
               '0.0001189020     rho0       e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB-',
               'Decay myB0',
               '0.0000000000    D-     mu+    myHNL_mu    PHSP;',
               '0.0000000000    D*-    mu+    myHNL_mu    PHSP;',
               '0.0045804488    pi-    mu+    myHNL_mu    PHSP;',
               '0.0001646052    rho-   mu+    myHNL_mu    PHSP;',
               '0.0000000000    D-     mu+    myHNL_e     PHSP;',
               '0.0000000000    D*-    mu+    myHNL_e     PHSP;',
               '0.0045804488    pi-    mu+    myHNL_e     PHSP;',
               '0.0001646052    rho-   mu+    myHNL_e     PHSP;',
               '0.0000000000     D-     e+     myHNL_mu    PHSP;',
               '0.0000000000     D*-    e+     myHNL_mu    PHSP;',
               '0.0046866648     pi-    e+     myHNL_mu    PHSP;',
               '0.0002217507     rho-   e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB0bar',
               'Decay myB0s',
               '0.0000000000    D_s-    mu+    myHNL_mu    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_mu    PHSP;',
               '0.0020595831    K-      mu+    myHNL_mu    PHSP;',
               '0.0001696267    K*-     mu+    myHNL_mu    PHSP;',
               '0.0000000000    D_s-    mu+    myHNL_e    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_e    PHSP;',
               '0.0020595831    K-      mu+    myHNL_e    PHSP;',
               '0.0001696267    K*-     mu+    myHNL_e    PHSP;',
               '0.0000000000    D_s-     e+     myHNL_mu    PHSP;',
               '0.0000000000    D_s*-    e+     myHNL_mu    PHSP;',
               '0.0021631939    K-       e+     myHNL_mu    PHSP;',
               '0.0002381747    K*-      e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB0sbar',
               'Decay myHNL_mu',
               '0.5     mu-    pi+    PHSP;',
