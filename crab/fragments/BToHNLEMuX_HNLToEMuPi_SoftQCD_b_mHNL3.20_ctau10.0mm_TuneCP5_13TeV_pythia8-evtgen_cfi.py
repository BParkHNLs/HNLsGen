    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_embedded = cms.vstring(
               ...
               'Decay myB+',
               '0.1710291237               mu+    myHNL_mu    PHSP;',
               '0.0063607829    anti-D0    mu+    myHNL_mu    PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_mu    PHSP;',
               '0.0172842207    pi0        mu+    myHNL_mu    PHSP;',
               '0.0150601306    rho0       mu+    myHNL_mu    PHSP;',
               '0.1710291237               mu+    myHNL_e     PHSP;',
               '0.0063607829    anti-D0    mu+    myHNL_e     PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_e     PHSP;',
               '0.0172842207    pi0        mu+    myHNL_e     PHSP;',
               '0.0150601306    rho0       mu+    myHNL_e     PHSP;',
               '0.1707532704                e+     myHNL_mu    PHSP;',
               '0.0115166726     anti-D0    e+     myHNL_mu    PHSP;',
               '0.0007003485     anti-D*0   e+     myHNL_mu    PHSP;',
               '0.0173578524     pi0        e+     myHNL_mu    PHSP;',
               ...
               '0.0323290021    pi-    mu+    myHNL_mu    PHSP;',
               '0.0279683906    rho-   mu+    myHNL_mu    PHSP;',
               '0.0053213381    D-     mu+    myHNL_e     PHSP;',
               '0.0000000000    D*-    mu+    myHNL_e     PHSP;',
               '0.0323290021    pi-    mu+    myHNL_e     PHSP;',
               '0.0279683906    rho-   mu+    myHNL_e     PHSP;',
               '0.0099210306     D-     e+     myHNL_mu    PHSP;',
               '0.0008627137     D*-    e+     myHNL_mu    PHSP;',
               '0.0324686857     pi-    e+     myHNL_mu    PHSP;',
               ...
               '0.0300343834    K-      mu+    myHNL_mu    PHSP;',
               '0.0310543227    K*-     mu+    myHNL_mu    PHSP;',
               '0.0041007364    D_s-    mu+    myHNL_e    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_e    PHSP;',
               '0.0300343834    K-      mu+    myHNL_e    PHSP;',
               '0.0310543227    K*-     mu+    myHNL_e    PHSP;',
               '0.0083348743    D_s-     e+     myHNL_mu    PHSP;',
               '0.0002506519    D_s*-    e+     myHNL_mu    PHSP;',
               '0.0302439352    K-       e+     myHNL_mu    PHSP;',
