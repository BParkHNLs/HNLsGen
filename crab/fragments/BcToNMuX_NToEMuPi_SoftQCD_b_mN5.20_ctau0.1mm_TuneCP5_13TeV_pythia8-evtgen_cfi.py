...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Bc -> mu N X, with long-lived N, m=5.20GeV, ctau=0.1mm'),
    name = cms.untracked.string('Bc -> mu N X, with long-lived N, m=5.20GeV, ctau=0.1mm'),
...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('evt_BHNL_mass5.20_ctau0.1_maj.pdl'),
            user_decay_embedded = cms.vstring(
               ...
               'Decay myBc+',
               '21.5444377469               mu+    myHNL_mu    PHSP;',
               '21.5444377469               mu+    myHNL_e     PHSP;',
               '21.5826918140                e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myBc-',
               'Decay myHNL_mu',
               '0.5     mu-    pi+    PHSP;',
