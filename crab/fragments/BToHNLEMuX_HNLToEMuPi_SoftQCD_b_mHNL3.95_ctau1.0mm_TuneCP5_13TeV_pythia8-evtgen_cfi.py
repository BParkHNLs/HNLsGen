...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=3.95GeV, ctau=1.0mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=3.95GeV, ctau=1.0mm'),
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            #particle_property_file = cms.FileInPath('GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass3.95_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_BHNL_mass3.95_ctau1.0_maj.pdl'),
            particle_property_file = cms.FileInPath('evt_BHNL_mass3.95_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('/GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass3.95_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('evt_BHNL_mass3.95_ctau1.0_maj.pdl'),
            user_decay_embedded = cms.vstring(
               ...
               'Decay myB+',
               '0.1260057490               mu+    myHNL_mu    PHSP;',
               '0.0000000000    anti-D0    mu+    myHNL_mu    PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_mu    PHSP;',
               '0.0049193055    pi0        mu+    myHNL_mu    PHSP;',
               '0.0008792635    rho0       mu+    myHNL_mu    PHSP;',
               '0.1260057490               mu+    myHNL_e     PHSP;',
               '0.0000000000    anti-D0    mu+    myHNL_e     PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_e     PHSP;',
               '0.0049193055    pi0        mu+    myHNL_e     PHSP;',
               '0.0008792635    rho0       mu+    myHNL_e     PHSP;',
               '0.1259799906                e+     myHNL_mu    PHSP;',
               '0.0000000000     anti-D0    e+     myHNL_mu    PHSP;',
               '0.0000000000     anti-D*0   e+     myHNL_mu    PHSP;',
               '0.0049851674     pi0        e+     myHNL_mu    PHSP;',
               '0.0009585556     rho0       e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB-',
               'Decay myB0',
               '0.0000000000    D-     mu+    myHNL_mu    PHSP;',
               '0.0000000000    D*-    mu+    myHNL_mu    PHSP;',
               '0.0091249353    pi-    mu+    myHNL_mu    PHSP;',
               '0.0016360409    rho-   mu+    myHNL_mu    PHSP;',
               '0.0000000000    D-     mu+    myHNL_e     PHSP;',
               '0.0000000000    D*-    mu+    myHNL_e     PHSP;',
               '0.0091249353    pi-    mu+    myHNL_e     PHSP;',
               '0.0016360409    rho-   mu+    myHNL_e     PHSP;',
               '0.0000000000     D-     e+     myHNL_mu    PHSP;',
               '0.0000000000     D*-    e+     myHNL_mu    PHSP;',
               '0.0092487872     pi-    e+     myHNL_mu    PHSP;',
               '0.0017833150     rho-   e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB0bar',
               'Decay myB0s',
               '0.0000000000    D_s-    mu+    myHNL_mu    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_mu    PHSP;',
               '0.0055748588    K-      mu+    myHNL_mu    PHSP;',
               '0.0018870015    K*-     mu+    myHNL_mu    PHSP;',
               '0.0000000000    D_s-    mu+    myHNL_e    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_e    PHSP;',
               '0.0055748588    K-      mu+    myHNL_e    PHSP;',
               '0.0018870015    K*-     mu+    myHNL_e    PHSP;',
               '0.0000000000    D_s-     e+     myHNL_mu    PHSP;',
               '0.0000000000    D_s*-    e+     myHNL_mu    PHSP;',
               '0.0057158968    K-       e+     myHNL_mu    PHSP;',
               '0.0020563178    K*-      e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB0sbar',
               'Decay myHNL_mu',
               '0.5     mu-    pi+    PHSP;',
