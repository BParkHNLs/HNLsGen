...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Bc -> mu N X, with long-lived N, m=6.10GeV, ctau=0.1mm'),
    name = cms.untracked.string('Bc -> mu N X, with long-lived N, m=6.10GeV, ctau=0.1mm'),
...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('evt_BHNL_mass6.10_ctau0.1_maj.pdl'),
            user_decay_embedded = cms.vstring(
               ...
               'Decay myBc+',
               '0.7402433004               mu+    myHNL_mu    PHSP;',
               '0.7402433004               mu+    myHNL_e     PHSP;',
               '0.9145047942                e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myBc-',
               'Decay myHNL_mu',
               '0.5     mu-    pi+    PHSP;',
