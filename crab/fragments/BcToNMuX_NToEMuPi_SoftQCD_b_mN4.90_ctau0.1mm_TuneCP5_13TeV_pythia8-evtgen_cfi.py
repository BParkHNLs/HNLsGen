...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Bc -> mu N X, with long-lived N, m=4.90GeV, ctau=0.1mm'),
    name = cms.untracked.string('Bc -> mu N X, with long-lived N, m=4.90GeV, ctau=0.1mm'),
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_embedded = cms.vstring(
               ...
               'Decay myBc+',
               '29.7254203111               mu+    myHNL_mu    PHSP;',
               '29.7254203111               mu+    myHNL_e     PHSP;',
               '29.7362819823                e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myBc-',
               'Decay myHNL_mu',
               '0.5     mu-    pi+    PHSP;',
