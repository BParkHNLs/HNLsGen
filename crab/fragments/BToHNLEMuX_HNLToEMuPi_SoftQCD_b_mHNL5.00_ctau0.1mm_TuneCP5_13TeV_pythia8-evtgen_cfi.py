...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=5.00GeV, ctau=0.1mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=5.00GeV, ctau=0.1mm'),
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('evt_BHNL_mass5.00_ctau0.1_maj.pdl'),
