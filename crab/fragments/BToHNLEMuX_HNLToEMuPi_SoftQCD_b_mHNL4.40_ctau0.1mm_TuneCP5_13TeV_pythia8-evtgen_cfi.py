...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=4.40GeV, ctau=0.1mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=4.40GeV, ctau=0.1mm'),
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            #particle_property_file = cms.FileInPath('GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass4.40_ctau0.1_maj.pdl'),
            #particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_BHNL_mass4.40_ctau0.1_maj.pdl'),
            particle_property_file = cms.FileInPath('evt_BHNL_mass4.40_ctau0.1_maj.pdl'),
            #particle_property_file = cms.FileInPath('/GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass4.40_ctau0.1_maj.pdl'),
            #particle_property_file = cms.FileInPath('evt_BHNL_mass4.40_ctau0.1_maj.pdl'),
