...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=3.40GeV, ctau=1.0mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=3.40GeV, ctau=1.0mm'),
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            #particle_property_file = cms.FileInPath('GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass3.40_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_BHNL_mass3.40_ctau1.0_maj.pdl'),
            particle_property_file = cms.FileInPath('evt_BHNL_mass3.40_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('/GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass3.40_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('evt_BHNL_mass3.40_ctau1.0_maj.pdl'),
            user_decay_embedded = cms.vstring(
               ...
               'Decay myB+',
               '0.1652057316               mu+    myHNL_mu    PHSP;',
               '0.0000000000    anti-D0    mu+    myHNL_mu    PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_mu    PHSP;',
               '0.0133698569    pi0        mu+    myHNL_mu    PHSP;',
               '0.0090192715    rho0       mu+    myHNL_mu    PHSP;',
               '0.1652057316               mu+    myHNL_e     PHSP;',
               '0.0000000000    anti-D0    mu+    myHNL_e     PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_e     PHSP;',
               '0.0133698569    pi0        mu+    myHNL_e     PHSP;',
               '0.0090192715    rho0       mu+    myHNL_e     PHSP;',
               '0.1649817506                e+     myHNL_mu    PHSP;',
               '0.0000009961     anti-D0    e+     myHNL_mu    PHSP;',
               '0.0000000000     anti-D*0   e+     myHNL_mu    PHSP;',
               '0.0134437582     pi0        e+     myHNL_mu    PHSP;',
               '0.0092051407     rho0       e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB-',
               'Decay myB0',
               '0.0000000000    D-     mu+    myHNL_mu    PHSP;',
               '0.0000000000    D*-    mu+    myHNL_mu    PHSP;',
               '0.0249641475    pi-    mu+    myHNL_mu    PHSP;',
               '0.0167541060    rho-   mu+    myHNL_mu    PHSP;',
               '0.0000000000    D-     mu+    myHNL_e     PHSP;',
               '0.0000000000    D*-    mu+    myHNL_e     PHSP;',
               '0.0249641475    pi-    mu+    myHNL_e     PHSP;',
               '0.0167541060    rho-   mu+    myHNL_e     PHSP;',
               '0.0000002504     D-     e+     myHNL_mu    PHSP;',
               '0.0000000000     D*-    e+     myHNL_mu    PHSP;',
               '0.0251040316     pi-    e+     myHNL_mu    PHSP;',
               '0.0170990420     rho-   e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB0bar',
               'Decay myB0s',
               '0.0000000000    D_s-    mu+    myHNL_mu    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_mu    PHSP;',
               '0.0214773120    K-      mu+    myHNL_mu    PHSP;',
               '0.0188577064    K*-     mu+    myHNL_mu    PHSP;',
               '0.0000000000    D_s-    mu+    myHNL_e    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_e    PHSP;',
               '0.0214773120    K-      mu+    myHNL_e    PHSP;',
               '0.0188577064    K*-     mu+    myHNL_e    PHSP;',
               '0.0000000000    D_s-     e+     myHNL_mu    PHSP;',
               '0.0000000000    D_s*-    e+     myHNL_mu    PHSP;',
               '0.0216745375    K-       e+     myHNL_mu    PHSP;',
               '0.0192231242    K*-      e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB0sbar',
               'Decay myHNL_mu',
               '0.5     mu-    pi+    PHSP;',
