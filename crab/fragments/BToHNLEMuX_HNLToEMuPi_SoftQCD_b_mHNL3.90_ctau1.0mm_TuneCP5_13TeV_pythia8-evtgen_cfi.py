...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=3.90GeV, ctau=1.0mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=3.90GeV, ctau=1.0mm'),
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            #particle_property_file = cms.FileInPath('GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass3.90_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_BHNL_mass3.90_ctau1.0_maj.pdl'),
            particle_property_file = cms.FileInPath('evt_BHNL_mass3.90_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('/GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass3.90_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('evt_BHNL_mass3.90_ctau1.0_maj.pdl'),
            user_decay_embedded = cms.vstring(
               ...
               'Decay myB+',
               '0.1308418951               mu+    myHNL_mu    PHSP;',
               '0.0000000000    anti-D0    mu+    myHNL_mu    PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_mu    PHSP;',
               '0.0055185165    pi0        mu+    myHNL_mu    PHSP;',
               '0.0011965896    rho0       mu+    myHNL_mu    PHSP;',
               '0.1308418951               mu+    myHNL_e     PHSP;',
               '0.0000000000    anti-D0    mu+    myHNL_e     PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_e     PHSP;',
               '0.0055185165    pi0        mu+    myHNL_e     PHSP;',
               '0.0011965896    rho0       mu+    myHNL_e     PHSP;',
               '0.1307942746                e+     myHNL_mu    PHSP;',
               '0.0000000000     anti-D0    e+     myHNL_mu    PHSP;',
               '0.0000000000     anti-D*0   e+     myHNL_mu    PHSP;',
               '0.0055857551     pi0        e+     myHNL_mu    PHSP;',
               '0.0012861400     rho0       e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB-',
               'Decay myB0',
               '0.0000000000    D-     mu+    myHNL_mu    PHSP;',
               '0.0000000000    D*-    mu+    myHNL_mu    PHSP;',
               '0.0102443227    pi-    mu+    myHNL_mu    PHSP;',
               '0.0022258536    rho-   mu+    myHNL_mu    PHSP;',
               '0.0000000000    D-     mu+    myHNL_e     PHSP;',
               '0.0000000000    D*-    mu+    myHNL_e     PHSP;',
               '0.0102443227    pi-    mu+    myHNL_e     PHSP;',
               '0.0022258536    rho-   mu+    myHNL_e     PHSP;',
               '0.0000000000     D-     e+     myHNL_mu    PHSP;',
               '0.0000000000     D*-    e+     myHNL_mu    PHSP;',
               '0.0103708471     pi-    e+     myHNL_mu    PHSP;',
               '0.0023921581     rho-   e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB0bar',
               'Decay myB0s',
               '0.0000000000    D_s-    mu+    myHNL_mu    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_mu    PHSP;',
               '0.0065433049    K-      mu+    myHNL_mu    PHSP;',
               '0.0025725760    K*-     mu+    myHNL_mu    PHSP;',
               '0.0000000000    D_s-    mu+    myHNL_e    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_e    PHSP;',
               '0.0065433049    K-      mu+    myHNL_e    PHSP;',
               '0.0025725760    K*-     mu+    myHNL_e    PHSP;',
               '0.0000000000    D_s-     e+     myHNL_mu    PHSP;',
               '0.0000000000    D_s*-    e+     myHNL_mu    PHSP;',
               '0.0066909302    K-       e+     myHNL_mu    PHSP;',
               '0.0027617960    K*-      e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB0sbar',
               'Decay myHNL_mu',
               '0.5     mu-    pi+    PHSP;',
