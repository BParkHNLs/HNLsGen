...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('B -> mu N X, with long-lived N, m=3.30GeV, ctau=1.0mm'),
    name = cms.untracked.string('B -> mu N X, with long-lived N, m=3.30GeV, ctau=1.0mm'),
...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            #particle_property_file = cms.FileInPath('GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass3.30_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('McRequest/evtGenData/evt_BHNL_mass3.30_ctau1.0_maj.pdl'),
            particle_property_file = cms.FileInPath('evt_BHNL_mass3.30_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('/GeneratorInterface/EvtGenInterface/data/evt_BHNL_mass3.30_ctau1.0_maj.pdl'),
            #particle_property_file = cms.FileInPath('evt_BHNL_mass3.30_ctau1.0_maj.pdl'),
            user_decay_embedded = cms.vstring(
               ...
               'Decay myB+',
               '0.1687008585               mu+    myHNL_mu    PHSP;',
               '0.0000267992    anti-D0    mu+    myHNL_mu    PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_mu    PHSP;',
               '0.0152839352    pi0        mu+    myHNL_mu    PHSP;',
               '0.0118127864    rho0       mu+    myHNL_mu    PHSP;',
               '0.1687008585               mu+    myHNL_e     PHSP;',
               '0.0000267992    anti-D0    mu+    myHNL_e     PHSP;',
               '0.0000000000    anti-D*0   mu+    myHNL_e     PHSP;',
               '0.0152839352    pi0        mu+    myHNL_e     PHSP;',
               '0.0118127864    rho0       mu+    myHNL_e     PHSP;',
               '0.1684497605                e+     myHNL_mu    PHSP;',
               '0.0013292990     anti-D0    e+     myHNL_mu    PHSP;',
               '0.0000000000     anti-D*0   e+     myHNL_mu    PHSP;',
               '0.0153578721     pi0        e+     myHNL_mu    PHSP;',
               '0.0120152386     rho0       e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB-',
               'Decay myB0',
               '0.0000058277    D-     mu+    myHNL_mu    PHSP;',
               '0.0000000000    D*-    mu+    myHNL_mu    PHSP;',
               '0.0285636738    pi-    mu+    myHNL_mu    PHSP;',
               '0.0219402778    rho-   mu+    myHNL_mu    PHSP;',
               '0.0000058277    D-     mu+    myHNL_e     PHSP;',
               '0.0000000000    D*-    mu+    myHNL_e     PHSP;',
               '0.0285636738    pi-    mu+    myHNL_e     PHSP;',
               '0.0219402778    rho-   mu+    myHNL_e     PHSP;',
               '0.0010716201     D-     e+     myHNL_mu    PHSP;',
               '0.0000000000     D*-    e+     myHNL_mu    PHSP;',
               '0.0287037808     pi-    e+     myHNL_mu    PHSP;',
               '0.0223159610     rho-   e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB0bar',
               'Decay myB0s',
               '0.0000000000    D_s-    mu+    myHNL_mu    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_mu    PHSP;',
               '0.0255851713    K-      mu+    myHNL_mu    PHSP;',
               '0.0245231523    K*-     mu+    myHNL_mu    PHSP;',
               '0.0000000000    D_s-    mu+    myHNL_e    PHSP;',
               '0.0000000000    D_s*-   mu+    myHNL_e    PHSP;',
               '0.0255851713    K-      mu+    myHNL_e    PHSP;',
               '0.0245231523    K*-     mu+    myHNL_e    PHSP;',
               '0.0007447329    D_s-     e+     myHNL_mu    PHSP;',
               '0.0000000000    D_s*-    e+     myHNL_mu    PHSP;',
               '0.0257890402    K-       e+     myHNL_mu    PHSP;',
               '0.0249180918    K*-      e+     myHNL_mu    PHSP;',
               'Enddecay',
               'CDecay myB0sbar',
               'Decay myHNL_mu',
               '0.5     mu-    pi+    PHSP;',
